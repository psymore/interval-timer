const translations = {
  en: {
    ...
    "miniShowcase.eyebrow": "Try it right here",
    "miniShowcase.h2": "An always-on-top mini window",
    "miniShowcase.p": "Drag any edge or corner to resize it — same classic-Windows grip as the real app — then hit the size button to snap back to default. The buttons react to clicks, but this is a static demo, not a running timer.",
    "miniShowcase.hint": "↔ drag an edge or corner to resize",
  ...
  tr: {
    ...
    "miniShowcase.eyebrow": "Hemen burada deneyin",
    "miniShowcase.h2": "Her zaman üstte kalan bir mini pencere",
    "miniShowcase.p": "Yeniden boyutlandırmak için herhangi bir kenardan ya da köşeden tutun — gerçek uygulamadaki klasik Windows tutamacının aynısı — sonra varsayılan boyuta dönmek için boyut sıfırlama düğmesine basın. Düğmeler tıklamalara tepki verir ama bu çalışan bir sayaç değil, statik bir demo.",
    "miniShowcase.hint": "↔ yeniden boyutlandırmak için bir kenar ya da köşeden sürükleyin",
