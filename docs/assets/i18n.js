const translations = {
  en: {
    ...
    "features.card4.p": "Pop out a small frameless timer that floats above everything else while you work — resize it to fit your screen, synced live with the main window, and snap back to default size in one click.",
    "features.card4.shot.alt": "The always-on-top mini window, resized larger, showing a running interval timer",
  ...
  tr: {
    ...
    "features.card4.p": "Çalışırken her şeyin üzerinde yüzen, çerçevesiz küçük bir sayacı ayrı bir pencerede açın; ekranınıza göre yeniden boyutlandırın, ana pencereyle canlı senkronize olsun, tek tıkla varsayılan boyuta dönün.",
    "features.card4.shot.alt": "Daha büyük boyuta getirilmiş, çalışan bir aralık sayacını gösteren her zaman üstte kalan mini pencere",
