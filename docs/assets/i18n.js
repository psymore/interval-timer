const translations = {
  en: {
    ...
    "miniShowcase.hint": "↔ drag an edge or corner to resize, or the window to move it",
  ...
  tr: {
    ...
    "miniShowcase.hint": "↔ yeniden boyutlandırmak için bir kenar/köşeden, taşımak için pencereden sürükleyin",
